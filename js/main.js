$(document).ready(function(){
    ...
    $('.search-book-button').click(function(e){
        ...
        swal({
           title: "¿Qué medicamento estás buscando?",
           text: "Por favor escribe el nombre del medicamento",
           type: "input",   
           showCancelButton: true,
           closeOnConfirm: false,
           animation: "slide-from-top",
           ...
           inputPlaceholder: "Escribe aquí el nombre del medicamento" }, 
      function(inputValue){
           if (inputValue === false) return false;  

           if (inputValue === "") {
               swal.showInputError("Debes escribir el nombre del Medicamento");     
               return false;   
           } 
